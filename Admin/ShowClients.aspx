            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        var clientBoxHTML = '<div class="col-lg-3"> <div class="ibox"> <div class="ibox-content product-box"> <div class="product-imitation"> <img  src="img/logos/' + data[i].ClientLogoURL + '"/> </div><div class="product-desc"> <span class="product-name"> ' + data[i].ClientName + '</span> <div class="m-t text-right"> <a href="ShowEmployees.aspx?Client=' + data[i].ClientId + '|' + data[i].ClientName + '" class="btn btn-xs btn-outline btn-primary">Select</a> </div></div></div></div></div>';
