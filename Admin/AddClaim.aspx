...
<asp:Content ID="Content1" ContentPlaceHolderID="body" Runat="Server">
    ...
    <script>
        ...
        function addTravelExpense() {
            ...
            claimJsonLines[0].ClaimLines[0].Purpose = $('#travelPurpose').val();
            claimJsonLines[0].ClaimLines[0].TravelMode = $('input[name=a]:checked', '#travelForm').val();
            claimJsonLines[0].ClaimLines[0].ExpenseDate = $('#travelDate').val();
            claimJsonLines[0].ClaimLines[0].TravelFromPlace = $('#travelFrom').val();
            claimJsonLines[0].ClaimLines[0].TravelToPlace = $('#travelTo').val();
            claimJsonLines[0].ClaimLines[0].Distance = $('#travelDistance').val();
            claimJsonLines[0].ClaimLines[0].Rate = $('#rate').val();
        ...
        function initiateClaim() {
            ...
            else
            {
                ...
                $.getJSON('api/getLastClaimHead/'+EmpId, function (result) {
                    ...
                    //    data: JSON.stringify('{"ClaimHead":[{"EmpId":24,"ClaimNumber":"Rel-32015-21-001","ClaimTitle":"Mumbai To Delhi","Status":1}]}'),
